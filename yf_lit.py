...
if side_bar == 'Home':
    ...
    if st.button('Run Analysis'):
        ...
        def fetch_llm_response():
            for text in y.llm(prompt=prompt):  # ❌ No async for-loop, just a generator
                yield text  # ✅ Stream each chunk as it arrives

        # ✅ Stream response in sidebar
        st.sidebar.write('Investment Report (Generated by AI)')
        st.sidebar.write_stream(fetch_llm_response())  # Handles async response
